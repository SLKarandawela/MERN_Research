      ...
      <div>
        ...
        <Row>
          ...
          <Col md={6} className="auth_right_col">
            <h1 className="auth_top_header">Staff Register</h1>
            <h6 id="acadRegLink">
              {" "}
            ...
            <Form className="login_form">
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label className="FormLabelStyler">Staff Type</Form.Label>

              
              <Form.Select aria-label="Default select example" value={role} onChange={(e)=>{setUserRole(e.target.value)}}>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label className="FormLabelStyler">Faculty</Form.Label>
